      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between border-b border-gray-200 pb-6 mb-8">
        <div className="flex justify-between items-center w-full md:w-auto">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-orange-500 to-teal-600 bg-clip-text text-transparent">
              All Articles
            </h2>
          </div>
        ...
        <div className="relative mt-4 md:mt-0 w-full md:w-72 group">
          <input
            ...
            className="w-full pl-4 pr-12 py-2 rounded-full border border-gray-300 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 hover:border-orange-400 focus:outline-none text-sm transition-all duration-200"
          />
          {/* Search Icon on Right */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="absolute right-3 top-2.5 h-5 w-5 text-gray-500 group-hover:text-orange-500 transition-colors duration-200 cursor-pointer"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
